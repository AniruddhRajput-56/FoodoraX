      ...
      <div className="bg-white p-4 rounded-2xl shadow-lg w-96">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full  border-black px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black"
          ...
          <div>
            ...
            <input
              type="email"
              className="w-full  border  border-black px-4 py-2  rounded-lg focus:outline-none focus:ring-2 focus:ring-black"
